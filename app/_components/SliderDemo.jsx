...
export default function VerticalDotsCarousel() {
  return (
    <div className="relative flex items-center justify-center h-full">
      ...
      {/* Vertical Dots */}
      <div className="swiper-pagination-vertical absolute md:top-1/2 md:-translate-y-1/2 top-1/2 translate-y-58 md:!-left-10 md:mt-15 h-full flex md:flex-col justify-center md:!space-y-3 space-x-2 " />

      {/* Arrows OUTSIDE Swiper */}
      <button className="custom-prev absolute md:-left-18 left-0 md:top-[22rem]  z-50 p-3 bg-transparent cursor-pointer ">
        <ChevronLeftIcon className="md:h-12 h-8 text-white" />
      </button>
      <button className="custom-next absolute md:-right-18  right-0 md:top-[22rem]  z-50 p-3  bg-transparent cursor-pointer">
